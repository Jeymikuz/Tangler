...
{
    public class EditStatusHandler : IRequestHandler<EditStatusCommand, Result<Status>>
    {
        private readonly DataContext _context;
        private readonly IUserAccessor _userAccessor;

        public EditStatusHandler(DataContext context, IUserAccessor userAccessor)
        {
            _context = context;
            _userAccessor = userAccessor;
        }

        public async Task<Result<Status>> Handle(EditStatusCommand request, CancellationToken cancellationToken)
        {
