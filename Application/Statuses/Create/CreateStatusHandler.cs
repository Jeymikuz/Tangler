...
{
    public class CreateStatusHandler : IRequestHandler<CreateStatusCommand, Result<Status>>
    {
        private readonly IUserAccessor _userAccessor;
        private readonly DataContext _context;

        public CreateStatusHandler(IUserAccessor userAccessor, DataContext context)
        {
            _userAccessor = userAccessor;
            _context = context;
        }

        public async Task<Result<Status>> Handle(CreateStatusCommand request, CancellationToken cancellationToken)
        {
