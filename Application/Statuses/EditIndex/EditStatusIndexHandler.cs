...
{
    public class EditStatusIndexHandler : IRequestHandler<EditStatusIndexCommand, Result<Unit>>
    {
        private readonly DataContext context;
        private readonly IUserAccessor userAccessor;

        public EditStatusIndexHandler(DataContext context, IUserAccessor userAccessor)
        {
            this.context = context;
            this.userAccessor = userAccessor;
        }

        public async Task<Result<Unit>> Handle(EditStatusIndexCommand request, CancellationToken cancellationToken)
        {
