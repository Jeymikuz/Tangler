...
{
    public class DeleteStatusHandler : IRequestHandler<DeleteStatusCommand, Result<Unit>>
    {
        private readonly DataContext _context;
        private readonly IUserAccessor _userAccessor;

        public DeleteStatusHandler(DataContext context, IUserAccessor userAccessor)
        {
            _context = context;
            _userAccessor = userAccessor;
        }

        public async Task<Result<Unit>> Handle(DeleteStatusCommand request, CancellationToken cancellationToken)
        {
