...
{
    public class GetStatusesListHandler : IRequestHandler<GetStatusesListQuery, Result<List<StatusGroup>>>
    {
        private readonly IUserAccessor _userAccessor;
        private readonly DataContext _context;

        public GetStatusesListHandler(IUserAccessor userAccessor, DataContext context)
        {
            _userAccessor = userAccessor;
            _context = context;
        }

        public async Task<Result<List<StatusGroup>>> Handle(GetStatusesListQuery request, CancellationToken cancellationToken)
        {
