...
{
    public class GetIntegrationsListHandler : IRequestHandler<GetIntegrationsListQuery, Result<ICollection<IntegrationDto>>>
    {
        private readonly DataContext _context;
        private readonly IUserAccessor _userAccessor;

        public GetIntegrationsListHandler(DataContext context, IUserAccessor userAccessor)
        {
            _context = context;
            _userAccessor = userAccessor;
        }

        public async Task<Result<ICollection<IntegrationDto>>> Handle(GetIntegrationsListQuery request, CancellationToken cancellationToken)
        {
