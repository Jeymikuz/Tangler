...
{
    public class GetLatestOrdersHandler:IRequestHandler<GetLatestOrdersCommand, Unit>
    {
        private readonly IManageOrders<WoocommerceService> _wService;

        public GetLatestOrdersHandler(IManageOrders<WoocommerceService> wService)
        {
            _wService = wService;
        }
