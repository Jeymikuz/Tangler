...
{
    public class CreateCompanyHandler : IRequestHandler<CreateCompanyCommand, Result<Unit>>
    {
        private readonly DataContext _context;
        private readonly UserManager<AppUser> _userManager;

        public CreateCompanyHandler(DataContext context, UserManager<AppUser> userManager)
        {
