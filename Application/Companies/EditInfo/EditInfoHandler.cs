...
{
    public class EditInfoHandler : IRequestHandler<EditInfoCommand, Result<Unit>>
    {
        private readonly DataContext _context;
        private readonly IUserAccessor _userAccessor;

        public EditInfoHandler(DataContext context, IUserAccessor userAccessor)
        {
            _context = context;
            _userAccessor = userAccessor;
        }

        public async Task<Result<Unit>> Handle(EditInfoCommand request, CancellationToken cancellationToken)
        {
