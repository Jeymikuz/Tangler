...
{
    public class EditStatusGroupHandler : IRequestHandler<EditStatusGroupCommand, Result<StatusGroup>>
    {
        private readonly DataContext _context;
        private readonly IUserAccessor _userAccessor;

        public EditStatusGroupHandler(DataContext context, IUserAccessor userAccessor)
        {
            _context = context;
            _userAccessor = userAccessor;
        }

        public async Task<Result<StatusGroup>> Handle(EditStatusGroupCommand request, CancellationToken cancellationToken)
        {
