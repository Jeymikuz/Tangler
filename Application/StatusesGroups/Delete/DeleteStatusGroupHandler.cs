...
{
    public class DeleteStatusGroupHandler : IRequestHandler<DeleteStatusGroupCommand, Result<Unit>>
    {
        private readonly DataContext _context;
        private readonly IUserAccessor _userAccessor;
   //     private readonly ILogger<DeleteStatusGroupHandler> _logger;

        public DeleteStatusGroupHandler(DataContext context, IUserAccessor userAccessor, ILogger<DeleteStatusGroupHandler> logger)
        {
            _context = context;
...
//            _logger = logger;
        ...
        public async Task<Result<Unit>> Handle(DeleteStatusGroupCommand request, CancellationToken cancellationToken)
        {
