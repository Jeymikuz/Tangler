...
{
    public class CreateHandler : IRequestHandler<CreateCommand, Result<StatusGroup>>
    {
        ...
        public async Task<Result<StatusGroup>> Handle(CreateCommand request, CancellationToken cancellationToken)
        {
