...
{
    public class CreateHandler : IRequestHandler<CreateCommand, Result<OrderDto>>
    {
        ...
        public async Task<Result<OrderDto>> Handle(CreateCommand request, CancellationToken cancellationToken)
        {
