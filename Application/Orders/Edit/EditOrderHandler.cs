...
{
    public class EditOrderHandler : IRequestHandler<EditOrderCommand, Result<OrderDto>>
    {
        private readonly IUserAccessor _userAccessor;
        private readonly DataContext _context;
        private readonly IMapper _mapper;

        public EditOrderHandler(IUserAccessor userAccessor, DataContext context, IMapper mapper)
        {
