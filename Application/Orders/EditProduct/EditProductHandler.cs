...
{
    public class EditProductHandler : IRequestHandler<EditProductCommand, Result<OrderDto>>
    {
        private readonly IUserAccessor _userAccessor;
        private readonly DataContext _context;
        private readonly IMapper _mapper;

        public EditProductHandler(IUserAccessor userAccessor, DataContext context, IMapper mapper)
        {
        ...
        public async Task<Result<OrderDto>> Handle(EditProductCommand request, CancellationToken cancellationToken)
        {
